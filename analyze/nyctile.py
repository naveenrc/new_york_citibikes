...
def nyc_map(title):
    ...
    fig = figure(tools='pan, wheel_zoom, box_zoom, tap, reset, save', x_range=x_range, y_range=y_range, width=1200, height=600,
                 active_scroll="auto",title=title, toolbar_location="right")
